...
export const ROADMAP_ITEMS: RoadmapToolItem[] = [
  ...
  // --- FASE 4: TEXTO, DADOS & PRODUTIVIDADE (51 a 70) ---
  {
    id: 51,
...
export default function RoadmapView() {
  ...
  const phases = [
    ...
    },
    {
      ...
      description:
        "Compactador ZIP no browser, PDF para imagens, testador de Regex, conversores de dados (JSON ↔ CSV, JSON ↔ YAML) e decodificador JWT.",
    },
    {
      id: "Fase 5 (v1.4)",
      phaseNumber: "5",
